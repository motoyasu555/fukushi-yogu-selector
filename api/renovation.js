export default async function handler(req, res) {
  ...
  try {
    ...
    const prompt = [
      ...
      "同時に、理由書の記入欄へ転記しやすい短縮版として user_status_short、care_status_short、life_change_goal_short も出力してください。",
      "短縮版は各80〜120字程度を目安にし、枠内に収まりやすい簡潔な提出文にしてください。",
      ...
      "konnan_jokyo_by_categoryには、①で該当項目がある分類だけを出力し、各分類について具体的な困難な状況を3〜6文で書いてください。",
      "各分類には text に詳細版、text_short に理由書欄へ転記しやすい80〜140字程度の短縮版を入れてください。",
      ...
      "各分類には houshin に詳細版、houshin_short に理由書欄へ転記しやすい35〜65字程度の短縮版を入れてください。",
      ...
      "  \"user_status_short\": \"利用者の身体状況（転記用短縮版）\",",
      "  \"care_status\": \"介護状況\",",
      "  \"care_status_short\": \"介護状況（転記用短縮版）\",",
      "  \"life_change_goal\": \"住宅改修により日常生活をどう変えたいか\",",
      "  \"life_change_goal_short\": \"住宅改修により日常生活をどう変えたいか（転記用短縮版）\",",
      "  \"seikatsu_dousa\": [{ \"category\": \"排泄|入浴|外出|その他の活動\", \"items\": [\"選択した項目名\"] }],",
      "  \"konnan_jokyo\": \"分類別内容を統合した具体的な困難な状況\",",
      "  \"konnan_jokyo_by_category\": [{ \"category\": \"排泄|入浴|外出|その他の活動\", \"items\": [\"①で選択した項目名\"], \"text\": \"分類別の具体的な困難な状況\", \"text_short\": \"分類別の具体的な困難な状況（転記用短縮版）\" }],",
      "  \"kaishuu_mokuteki\": [{ \"items\": [\"選択した改修目的・期待効果\"], \"houshin\": \"〜することで、〜が改善できる\" }],",
      "  \"kaishuu_mokuteki_by_category\": [{ \"category\": \"排泄|入浴|外出|その他の活動\", \"items\": [\"選択した改修目的・期待効果\"], \"houshin\": \"〜することで、〜が改善できる\", \"houshin_short\": \"改修の方針（転記用短縮版）\" }],",
