export default async function handler(req, res) {
  ...
  try {
    ...
    const prompt = [
      ...
      "利用者・ケアマネジャーからの相談内容を、介護保険課へ提出する住宅改修理由書の下書きとして転記しやすい形に整理してください。",
      "行政提出物であることを前提に、記載内容が不足している場合でも『詳細不明』『不明』『情報不足』『確認必要』『該当なし』などの粗い表現を文章欄に出さないでください。",
      "不足情報は断定せず、『相談内容からは〜が主な課題として整理される』『〜の場面で安全性を確保する必要がある』のように、提出文として自然な言い回しへ整えてください。",
      "",
      ...
      "care_statusは、本人の自立度、家族・介護者の介助状況、見守りの必要性、介助負担、夜間や外出時のリスクを入力根拠に基づき整理してください。入力にない場合でも『不明』『未確認』『訪問時確認』とは書かず、相談内容から読み取れる介助負担・安全確保の観点を中心にまとめてください。",
      ...
      "【その他の活動】その他（　　　）",
      "",
      "ステップ3：②具体的な困難な状況は、①で選択した【排泄】【入浴】【外出】【その他の活動】の分類ごとに必ず分けてください。",
      "konnan_jokyo_by_categoryには、①で該当項目がある分類だけを出力し、各分類について具体的な困難な状況を2〜4文で書いてください。現状より約3分の2の文字量に抑え、理由書の枠内へ転記しやすい密度にしてください。",
      "各分類の文章には、該当する生活動作、場所、姿勢変換、支持物の有無、転倒・転落リスク、介助者の負担、動作が中断する場面を含めてください。",
      "konnan_jokyoには、分類別の内容を行政提出用に自然につないだ総合文を入れてください。",
      "入力が短い場合でも『詳細不明』『情報不足』『確認が必要』とは書かず、相談内容から読み取れる生活動作上の支障を根拠に、提出文として成立する表現にしてください。",
      "",
      "ステップ4：③改修目的・期待効果を、②の分類別の困難状況に紐づけて選択してください。以下の文言と完全一致で選択してください。1つの改善したい生活動作につき複数選択可、最大4ブロックまでです。",
      ...
      "houshinは短すぎる表現を避け、取付位置・動作場面・期待される変化が分かるように15〜30字程度で具体化してください。",
      "kaishuu_mokuteki_by_categoryには、konnan_jokyo_by_categoryと同じ分類名で、チェックする目的・期待効果と改修の方針を分類別に出力してください。",
      "",
      ...
      "  \"konnan_jokyo\": \"分類別内容を統合した具体的な困難な状況\",",
      "  \"konnan_jokyo_by_category\": [{ \"category\": \"排泄|入浴|外出|その他の活動\", \"items\": [\"①で選択した項目名\"], \"text\": \"分類別の具体的な困難な状況\" }],",
      "  \"kaishuu_mokuteki\": [{ \"items\": [\"選択した改修目的・期待効果\"], \"houshin\": \"〜することで、〜が改善できる\" }],",
      "  \"kaishuu_mokuteki_by_category\": [{ \"category\": \"排泄|入浴|外出|その他の活動\", \"items\": [\"選択した改修目的・期待効果\"], \"houshin\": \"〜することで、〜が改善できる\" }],",
